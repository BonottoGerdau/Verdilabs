...
const int tempMax = 36;
const int tempMin = 28;
const int humidityMax = 95;
const int humidityMin = 70;
  ...
  Serial.print(ssid); Serial.println(" ...");
   ...
   while (WiFi.status() != WL_CONNECTED) { // Wait for the Wi-Fi to connect
    ...
    Serial.print('.');
                                   ...
                                   // Se conectar, mostra mensagens de sucesso no monitor e no display por dois segundos
