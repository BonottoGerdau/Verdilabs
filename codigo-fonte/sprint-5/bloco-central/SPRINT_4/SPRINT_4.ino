...
Essas medidas são enviadas a cada 10 segundos. O módulo i2cScanner.h, por sua vez, realiza uma scan da placa para encontrar periféricos
na rotina de erros. Po fim, o displaySymbols.h guarda o mapeamento dos ícones de temperatura e umidade para serem exibidos no display; por ora, 
...
3. Implementação de rotina de erros e verificação de periféricos para sensor, display e conexão Wi-Fi.
...
#include "i2cScanner.h"   // Módulo para escanear periféricos em I2C na rotina de erros
...
void checkSystem() {
  I2Cscan();          // Checa periféricos de I2C
  checkSensor();      // Checa se o sensor está funcionando
